...
1. _Name_ - Enter a descriptive name for your monitor, for example: "Contract Hash Verification".
2. _Hash Type_ - Choose the hashing algorithm you want to use for verification:
   1. `Keccak`
   2. `SHA256`
3. _Contract Bytecode Checksum_ - Enter the known, trusted hash value that the current bytecode should match.
4. _Initial Check_ - Choose whether you want an immediate verification when the detector is created.
